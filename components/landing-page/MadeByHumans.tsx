const MadeByHumans = () => {
  return (
    <section id="made-by-humans" className="w-full bg-gray-900 py-0">
      <div className="section-container opacity-0 animate-on-scroll pb-2">
        ...
        <div className="w-full rounded-2xl sm:rounded-3xl overflow-hidden relative mt-6 sm:mt-8">
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(rgba(17, 24, 39, 0.6), rgba(17, 24, 39, 0.6)), url('/landing-page/background-section3.png')",
            }}
          >
            <div className="flex items-center text-white">
              <img
                src="/landing-page/LiveletWhite.svg"
            ...
            <div className="w-[120%] bg-gray-900 h-10 rounded-t-lg absolute left-[-10%] bottom-0"></div>
          </div>
        </div>
      </div>
    </section>
