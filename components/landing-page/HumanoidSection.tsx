...
const HumanoidSection = () => {
  ...
  return (
    ...
    >
      <section
        className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-gray-900"
        id="why-humanoid"
      >
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            <div className="flex items-center gap-4 mb-2 md:mb-2 pt-8 sm:pt-6 md:pt-4"></div>
          ...
          >
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-pulse-900/40 to-gray-900/80"
                style={{
                  backgroundImage:
                    "url('/landing-page/background-section1.png')",
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">The idea</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're redefining collaboration, one real-time line of code
                    at a time.
                  </h3>
                </div>
              </div>
            ...
            >
              <div
                ...
                style={{
                  backgroundImage:
                    "url('/landing-page/background-section2.png')",
                  backgroundSize: "cover",
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">The purpose</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're making coding as interactive and intuitive as a
                    conversation.
                  </h3>
                </div>
              </div>
            ...
            >
              <div
                ...
                style={{
                  backgroundImage:
                    "url('/landing-page/background-section3.png')",
                  backgroundSize: "cover",
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're building a space for devs to grow together, not alone.
                  </h3>
                </div>
              </div>
            </div>
