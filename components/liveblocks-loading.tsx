...
export function Loading() {
  return (
    <div className="absolute inset-0 w-full h-full flex justify-center items-center bg-transparent">
      <svg
      ...
      >
        ...
        #top {
          ...
          animation: offset-distance var(--duration) infinite var(--ease-in-out-quart),
        ...
        <g id="group" fill="#959999" fillRule="evenodd" clipRule="evenodd">
